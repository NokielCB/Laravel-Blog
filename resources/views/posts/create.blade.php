<x-layout>
    <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="mb-8">
            <h2 class="text-3xl font-bold text-gray-900">Dodaj nowy post</h2>
            <p class="mt-2 text-gray-600">Stworz wpis, ustaw zdjecie i zdecyduj czy ma byc publiczny.</p>
        </div>
            ...
            <form method="POST" action="{{ route('posts.store') }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    ...
                    <input
                        ...
                        placeholder="Np. Jak zacząć z Laravel"
                    >
                    @error('title')
