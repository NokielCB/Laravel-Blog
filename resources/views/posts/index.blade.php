            ...
            <article
                ...
                <div class="p-6">
                    ...
                    <h3 class="text-xl font-bold text-gray-900 mb-2 hover:text-indigo-600 cursor-pointer">
                        <a href="post-detail.html">Rozpoczęcie przygody z Laravel 11</a>
                    </h3>
                    <p class="text-gray-600 text-sm mb-4 line-clamp-3">
                        Poznaj najnowszą wersję Laravel i dowiedz się, jak skonfigurować projekt w 5 minut używając
                        Laravel Sail i Docker.
                    </p>
                    <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-sm text-gray-700 font-medium">Jan Kowalski</span>
                        </div>
                        <span class="text-sm text-gray-500">2 godz. temu</span>
                    </div>
                </div>
            </article>
